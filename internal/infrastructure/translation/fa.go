...
var Persian = map[string]interface{}{
	...
	"success": map[string]interface{}{
		"userRegister":              "ثبت نام موفق بود! لطفاً ایمیل خود را بررسی کنید تا حساب خود را تأیید کرده و فرآیند ثبت نام را تکمیل نمایید.",
		...
		"changeLogo":                "لوگوی شرکت با موفقیت عوض شد.",
