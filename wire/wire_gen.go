...
var GeneralControllersProviderSet = wire.NewSet(general.NewGeneralUserController, general.NewGeneralProvinceController, wire.Struct(new(GeneralControllers), "*"))
